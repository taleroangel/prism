...
#if !defined(ARDUINO) && !defined(ESP8266) && !defined(ESP32) && !defined(IGNORE_ARDUINO_WARNING)
#warning "Neither ARDUINO nor ESP8266 are defined, FastLED module might not work. To disable this warning define IGNORE_ARDUINO_WARNING)"
#endif

template <uint8_t MAX_LEDS>
class NewtonFastLEDInterpreter
{
public:
...
public:
	...
	inline void Instruction(
		const PrismInstruction &instruction)
	{
